...
export default function Homepage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "We employ banking-grade security mechanisms. All user accounts can enforce 2-Factor Authentication (2FA), card database entries are protected under severe international PCI standards, and user balances are stored separately in modern, protected safe accounts."
    },
    {
      question: "What withdrawal methods are available and how long does it take?",
      answer: "Withdrawals are processed incredibly fast, typically in less than 2 hours. We support multiple payment systems including mobile banks, local card transfers, and secure crypto wallets with zero surprise dynamic charges."
    },
    {
